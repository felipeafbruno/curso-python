...
try:
    ...
    # transforma cada uma das linhas obtidas do banco de dados
    ...
    contatos = (
        ('Furtuna','456', grupos['Casa']),
        ('Bernardo', '789', grupos['Casa']),
        ('Felipe', '000', grupos['Trabalho']),
        ('Pedro', '987', None),
        ('Bernardete','654', None),
        ('Mariana','321', grupos['Trabalho'])
    )
